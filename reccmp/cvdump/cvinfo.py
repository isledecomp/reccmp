...
#      Character types
    ...
    0x0410: "T_32PCHAR",     # 32 bit pointer to 8 bit signed
    0x0510: "T_32PFCHAR",    # 16:32 pointer to 8 bit signed
    0x0610: "T_64PCHAR",     # 64 bit pointer to 8 bit signed

    0x0020: "T_UCHAR",       # 8 bit unsigned
    ...
    0x0420: "T_32PUCHAR",    # 32 bit pointer to 8 bit unsigned
    0x0520: "T_32PFUCHAR",   # 16:32 pointer to 8 bit unsigned
    0x0620: "T_64PUCHAR",    # 64 bit pointer to 8 bit unsigned


#      really a character types

    0x0070: "T_RCHAR",       # really a char
    ...
    0x0470: "T_32PRCHAR",    # 32 bit pointer to a real char
    0x0570: "T_32PFRCHAR",   # 16:32 pointer to a real char
    0x0670: "T_64PRCHAR",    # 64 bit pointer to a real char


#      really a wide character types

    0x0071: "T_WCHAR",       # wide char
    ...
    0x0471: "T_32PWCHAR",    # 32 bit pointer to a wide char
    0x0571: "T_32PFWCHAR",   # 16:32 pointer to a wide char
    0x0671: "T_64PWCHAR",    # 64 bit pointer to a wide char

#      really a 16-bit unicode char

    0x007a: "T_CHAR16",       # 16-bit unicode char
    0x017a: "T_PCHAR16",      # 16 bit pointer to a 16-bit unicode char
    0x027a: "T_PFCHAR16",     # 16:16 far pointer to a 16-bit unicode char
    0x037a: "T_PHCHAR16",     # 16:16 huge pointer to a 16-bit unicode char
    0x047a: "T_32PCHAR16",    # 32 bit pointer to a 16-bit unicode char
    0x057a: "T_32PFCHAR16",   # 16:32 pointer to a 16-bit unicode char
    0x067a: "T_64PCHAR16",    # 64 bit pointer to a 16-bit unicode char

#      really a 32-bit unicode char

    0x007b: "T_CHAR32",       # 32-bit unicode char
    0x017b: "T_PCHAR32",      # 16 bit pointer to a 32-bit unicode char
    0x027b: "T_PFCHAR32",     # 16:16 far pointer to a 32-bit unicode char
    0x037b: "T_PHCHAR32",     # 16:16 huge pointer to a 32-bit unicode char
    0x047b: "T_32PCHAR32",    # 32 bit pointer to a 32-bit unicode char
    0x057b: "T_32PFCHAR32",   # 16:32 pointer to a 32-bit unicode char
    0x067b: "T_64PCHAR32",    # 64 bit pointer to a 32-bit unicode char

#      8 bit int types

    0x0068: "T_INT1",        # 8 bit signed int
    ...
    0x0468: "T_32PINT1",     # 32 bit pointer to 8 bit signed int
    0x0568: "T_32PFINT1",    # 16:32 pointer to 8 bit signed int
    0x0668: "T_64PINT1",     # 64 bit pointer to 8 bit signed int

    0x0069: "T_UINT1",       # 8 bit unsigned int
    ...
    0x0469: "T_32PUINT1",    # 32 bit pointer to 8 bit unsigned int
    0x0569: "T_32PFUINT1",   # 16:32 pointer to 8 bit unsigned int
    0x0669: "T_64PUINT1",    # 64 bit pointer to 8 bit unsigned int


#      16 bit short types

    0x0011: "T_SHORT",       # 16 bit signed
    ...
    0x0411: "T_32PSHORT",    # 32 bit pointer to 16 bit signed
    0x0511: "T_32PFSHORT",   # 16:32 pointer to 16 bit signed
    0x0611: "T_64PSHORT",    # 64 bit pointer to 16 bit signed

    0x0021: "T_USHORT",      # 16 bit unsigned
    ...
    0x0421: "T_32PUSHORT",   # 32 bit pointer to 16 bit unsigned
    0x0521: "T_32PFUSHORT",  # 16:32 pointer to 16 bit unsigned
    0x0621: "T_64PUSHORT",   # 64 bit pointer to 16 bit unsigned


#      16 bit int types

    0x0072: "T_INT2",        # 16 bit signed int
    ...
    0x0472: "T_32PINT2",     # 32 bit pointer to 16 bit signed int
    0x0572: "T_32PFINT2",    # 16:32 pointer to 16 bit signed int
    0x0672: "T_64PINT2",     # 64 bit pointer to 16 bit signed int

    0x0073: "T_UINT2",       # 16 bit unsigned int
    ...
    0x0473: "T_32PUINT2",    # 32 bit pointer to 16 bit unsigned int
    0x0573: "T_32PFUINT2",   # 16:32 pointer to 16 bit unsigned int
    0x0673: "T_64PUINT2",    # 64 bit pointer to 16 bit unsigned int


#      32 bit long types

    0x0012: "T_LONG",        # 32 bit signed
    0x0022: "T_ULONG",       # 32 bit unsigned
    ...
    0x0412: "T_32PLONG",     # 32 bit pointer to 32 bit signed
    0x0422: "T_32PULONG",    # 32 bit pointer to 32 bit unsigned
    0x0512: "T_32PFLONG",    # 16:32 pointer to 32 bit signed
    0x0522: "T_32PFULONG",   # 16:32 pointer to 32 bit unsigned
    0x0612: "T_64PLONG",     # 64 bit pointer to 32 bit signed
    0x0622: "T_64PULONG",    # 64 bit pointer to 32 bit unsigned


#      32 bit int types

    0x0074: "T_INT4",        # 32 bit signed int
    ...
    0x0474: "T_32PINT4",     # 32 bit pointer to 32 bit signed int
    0x0574: "T_32PFINT4",    # 16:32 pointer to 32 bit signed int
    0x0674: "T_64PINT4",     # 64 bit pointer to 32 bit signed int

    0x0075: "T_UINT4",       # 32 bit unsigned int
    ...
    0x0475: "T_32PUINT4",    # 32 bit pointer to 32 bit unsigned int
    0x0575: "T_32PFUINT4",   # 16:32 pointer to 32 bit unsigned int
    0x0675: "T_64PUINT4",    # 64 bit pointer to 32 bit unsigned int


#      64 bit quad types

    0x0013: "T_QUAD",        # 64 bit signed
    ...
    0x0413: "T_32PQUAD",     # 32 bit pointer to 64 bit signed
    0x0513: "T_32PFQUAD",    # 16:32 pointer to 64 bit signed
    0x0613: "T_64PQUAD",     # 64 bit pointer to 64 bit signed

    0x0023: "T_UQUAD",       # 64 bit unsigned
    ...
    0x0423: "T_32PUQUAD",    # 32 bit pointer to 64 bit unsigned
    0x0523: "T_32PFUQUAD",   # 16:32 pointer to 64 bit unsigned
    0x0623: "T_64PUQUAD",    # 64 bit pointer to 64 bit unsigned


#      64 bit int types

    0x0076: "T_INT8",        # 64 bit signed int
    ...
    0x0476: "T_32PINT8",     # 32 bit pointer to 64 bit signed int
    0x0576: "T_32PFINT8",    # 16:32 pointer to 64 bit signed int
    0x0676: "T_64PINT8",     # 64 bit pointer to 64 bit signed int

    0x0077: "T_UINT8",       # 64 bit unsigned int
    ...
    0x0477: "T_32PUINT8",    # 32 bit pointer to 64 bit unsigned int
    0x0577: "T_32PFUINT8",   # 16:32 pointer to 64 bit unsigned int
    0x0677: "T_64PUINT8",    # 64 bit pointer to 64 bit unsigned int


#      128 bit octet types

    0x0014: "T_OCT",         # 128 bit signed
    ...
    0x0414: "T_32POCT",      # 32 bit pointer to 128 bit signed
    0x0514: "T_32PFOCT",     # 16:32 pointer to 128 bit signed
    0x0614: "T_64POCT",      # 64 bit pointer to 128 bit signed

    0x0024: "T_UOCT",        # 128 bit unsigned
    ...
    0x0424: "T_32PUOCT",     # 32 bit pointer to 128 bit unsigned
    0x0524: "T_32PFUOCT",    # 16:32 pointer to 128 bit unsigned
    0x0624: "T_64PUOCT",     # 64 bit pointer to 128 bit unsigned
...
#      32 bit real types
    ...
    0x0440: "T_32PREAL32",   # 32 bit pointer to 32 bit real
    0x0540: "T_32PFREAL32",  # 16:32 pointer to 32 bit real
    0x0640: "T_64PREAL32",   # 64 bit pointer to 32 bit real
...
#      64 bit real types
    ...
    0x0441: "T_32PREAL64",   # 32 bit pointer to 64 bit real
    0x0541: "T_32PFREAL64",  # 16:32 pointer to 64 bit real
    0x0641: "T_64PREAL64",   # 64 bit pointer to 64 bit real
...
#      boolean types
    ...
    0x0430: "T_32PBOOL08",   # 32 bit pointer to 8 bit boolean
    0x0530: "T_32PFBOOL08",  # 16:32 pointer to 8 bit boolean
    0x0630: "T_64PBOOL08",   # 64 bit pointer to 8 bit boolean

    0x0031: "T_BOOL16",      # 16 bit boolean
    ...
    0x0431: "T_32PBOOL16",   # 32 bit pointer to 18 bit boolean
    0x0531: "T_32PFBOOL16",  # 16:32 pointer to 16 bit boolean
    0x0631: "T_64PBOOL16",   # 64 bit pointer to 18 bit boolean

    0x0032: "T_BOOL32",      # 32 bit boolean
    ...
    0x0432: "T_32PBOOL32",   # 32 bit pointer to 32 bit boolean
    0x0532: "T_32PFBOOL32",  # 16:32 pointer to 32 bit boolean
    0x0632: "T_64PBOOL32",   # 64 bit pointer to 32 bit boolean

    0x0033: "T_BOOL64",      # 64 bit boolean
    ...
    0x0433: "T_32PBOOL64",   # 32 bit pointer to 64 bit boolean
    0x0533: "T_32PFBOOL64",  # 16:32 pointer to 64 bit boolean
    0x0633: "T_64PBOOL64",   # 64 bit pointer to 64 bit boolean


#      ???

    0x01f0: "T_NCVPTR",      # CV Internal type for created near pointers
    0x02f0: "T_FCVPTR",      # CV Internal type for created far pointers
    0x03f0: "T_HCVPTR",      # CV Internal type for created huge pointers
    0x04f0: "T_32NCVPTR",    # CV Internal type for created near 32-bit pointers
    0x05f0: "T_32FCVPTR",    # CV Internal type for created far 32-bit pointers
    0x06f0: "T_64NCVPTR",    # CV Internal type for created near 64-bit pointers
}
# fmt: on


def cvinfo_type_name(key: int) -> str:
    return _TYPE_ENUM_E.get(key, "???")
