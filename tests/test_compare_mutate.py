...
class TestMatchArrayElements:
    @pytest.fixture(name="types_db")
    def fixture_types(self) -> CvdumpTypesParser:
    ...
    def test_basic(self, db: EntityDb, types_db: CvdumpTypesParser):
    ...
    def test_key_unset(self, db: EntityDb):
    ...
    def test_type_is_scalar(self, db: EntityDb):
    ...
    def test_type_is_struct(self, db: EntityDb, types_db: CvdumpTypesParser):
    ...
    def test_type_orig_smaller(self, db: EntityDb, types_db: CvdumpTypesParser):
    ...
    def test_array_of_structs(self, db: EntityDb, types_db: CvdumpTypesParser):
    ...
    def test_array_of_arrays(self, db: EntityDb, types_db: CvdumpTypesParser):
    ...
    def test_array_of_structs_limit(self, db: EntityDb, types_db: CvdumpTypesParser):
        ...
        # Create first and second level entities. (Same as test_array_of_structs)
        orig_entities = [db.get_by_orig(addr) for addr in (100, 104, 108, 112)]
        recomp_entities = [db.get_by_recomp(addr) for addr in (100, 104, 108, 112)]
